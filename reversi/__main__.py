...
answer = str(input("Choose a gametype:\n"
                   ...
                   "3: AI vs AI\n"))
if answer == "3":
    players += (ReversiAIPlayer(name="W", board=game.board, game=game), ReversiAIPlayer(name="B", board=game.board, game=game),)
elif answer == "2":
    players += (DemoCliPlayer(name="W", board=game.board), ReversiAIPlayer(name="B", board=game.board), )
else:
